...
export const CATEGORIES = [
  ...
  { value: 'crime', label: 'Crime & Law Enforcement' },
  { value: 'cyber', label: 'Cyberattacks & Data Breaches' },
  { value: 'energy', label: 'Energy Crisis' },
  { value: 'migration', label: 'Migration & Refugees' },
  { value: 'religious', label: 'Religious Tensions' },
